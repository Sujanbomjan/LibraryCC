                                                    ...
                                                    <form action="<%=Common_Things.url%>/add-student-contro/" class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Email" name="email" value="<%if(obj_Student_Use_Bean.getEmail()!=null){out.println(obj_Student_Use_Bean.getEmail());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
