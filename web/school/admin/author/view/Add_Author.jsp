                            ...
                            <section class="panel">
                           	...
                           	%>
                                                ...
                                                <td><%=obj_Author_Use_Bean.getAuthor_name() %></td>
                                               	...
                                               	<td><a href="<%=Common_Things.url  %>/edit-author/?sl_no=<%=obj_Author_Use_Bean.getSl_no() %>&n=<%=obj_Author_Use_Bean.getAuthor_name() %>" class="btn btn-success btn-xs">Edit</a> </td>
                                            </tr>
