                            ...
                            <section class="panel">
                           	...
                           	%>
                                                ...
                                                <td><%=obj_Category_Use_Bean.getCategory_name() %></td>
                                               	...
                                               	<td><a href="<%=Common_Things.url %>/edit-category/?sl_no=<%=obj_Category_Use_Bean.getSl_no() %>&n=<%=obj_Category_Use_Bean.getCategory_name() %>" class="btn btn-success btn-xs">Edit</a> </td>
                                            </tr>
