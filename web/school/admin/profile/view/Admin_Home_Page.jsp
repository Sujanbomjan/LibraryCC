                                    ...
                                    <div>
                                        <h3 class="no-margin">
                                        	...
                                        	<%=obj_Home_Page_Use_Bean.getBook_count() %>
                                                ...
                                                <a href="<%=Common_Things.url %>/view-all-books/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna" %>"> Total Books</a>
                                    </div>
                                </div>
                            </section>
                        </div>
                                    ...
                                    <div>
                                        <h3 class="no-margin">
											<%=obj_Home_Page_Use_Bean.getStudent_count() %>
                                                                                      ...
                                                                                      <a href="<%=Common_Things.url %>/view-all-students/<%=12 %>">  Total Students</a>
                                    </div>
                                </div>
                            </section>
                        </div>
